...
class OllamaProvider(BaseLLMProvider):
    ...
    async def analyze_image(
        ...
        image_data: bytes,
        prompt: str,
        image_format: str = "png",  # noqa: ARG002 - Ollama auto-detects, kept for API consistency
        **kwargs: Any,
    ) -> LLMResponse:
        ...
        Args:
            ...
            image_format: Format of the image (unused, Ollama auto-detects)
    ...
    async def validate(self) -> bool:
        ...
        try:
            ...
            is_valid = any(name and self.model in name for name in model_names)
            if not is_valid:
                log.warning(
