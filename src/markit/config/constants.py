...
DEFAULT_LLM_WORKERS = 20  # Increased for better resource utilization
DEFAULT_CHUNK_WORKERS = 6  # Per-file chunk concurrency

# AIMD (Additive Increase Multiplicative Decrease) defaults
DEFAULT_AIMD_INITIAL_CONCURRENCY = 15
DEFAULT_AIMD_MAX_CONCURRENCY = 50
DEFAULT_AIMD_MIN_CONCURRENCY = 3
DEFAULT_AIMD_SUCCESS_THRESHOLD = 15
DEFAULT_AIMD_MULTIPLICATIVE_DECREASE = 0.5
DEFAULT_AIMD_COOLDOWN_SECONDS = 5.0

# Routing strategy defaults
DEFAULT_ROUTING_COST_WEIGHT = 0.6
DEFAULT_ROUTING_LOAD_WEIGHT = 0.4
