...
class ImageExtractor:
    ...
    async def extract_from_docx(self, docx_path: Path) -> list[ExtractedImage]:
        ...
        """
        return await anyio.to_thread.run_sync(self._extract_from_docx_sync, docx_path)  # type: ignore[attr-defined]
    ...
    async def extract_from_pptx(self, pptx_path: Path) -> list[ExtractedImage]:
        ...
        Returns:
            List of extracted images
        """
        return await anyio.to_thread.run_sync(self._extract_from_pptx_sync, pptx_path)  # type: ignore[attr-defined]
    ...
    async def extract_from_xlsx(self, xlsx_path: Path) -> list[ExtractedImage]:
        ...
        Returns:
            List of extracted images
        """
        return await anyio.to_thread.run_sync(self._extract_from_xlsx_sync, xlsx_path)  # type: ignore[attr-defined]
    ...
    async def extract_from_pdf(self, pdf_path: Path) -> list[ExtractedImage]:
        ...
        Returns:
            List of extracted images
        """
        return await anyio.to_thread.run_sync(self._extract_from_pdf_sync, pdf_path)  # type: ignore[attr-defined]
