...
| 文件 | 修改内容 |
|------|----------|
| `markit.json` | 权重、timeout、fallbacks、context_window_fallbacks |
...
```bash
markit packages/markit/tests/fixtures --llm --ocr --alt --desc --screenshot -o ./output --verbose
