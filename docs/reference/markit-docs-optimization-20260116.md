...
> 生成时间: 2026-01-17
> 分析范围: docs/, packages/markit/src/, packages/markit/tests/
> 版本: 0.2.0
...
- requirement.md:21 `markit document.pdf --image`
...
| MarkitConfig | `presets: dict[str, PresetConfig]` | config.py:164 |
...
markit document.pdf --alt --desc           # 手动启用图片分析
```
...
| docs/spec.md | 技术规格文档 |
| packages/markit/src/markit/cli.py | CLI 实现 |
| packages/markit/src/markit/config.py | 配置模型 |
| packages/markit/src/markit/config.schema.json | JSON Schema |
| packages/markit/src/markit/prompts/__init__.py | Prompt 管理 |
| packages/markit/pyproject.toml | 依赖配置 |
