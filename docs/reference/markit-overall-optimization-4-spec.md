...
> 基于 markit-overall-optimization-4.md 评审意见的深入分析
> 创建日期: 2026-01-20
> 最后更新: 2026-01-20
...
- [ ] 定义统一的异常层次结构（MarkitError, RetryableError, FatalError）
...
```python
# markit/exceptions.py (新建)
class MarkitError(Exception):
    """Base exception for all Markit errors."""
    pass

class RetryableError(MarkitError):
...
- 原始评审: [markit-overall-optimization-4.md](markit-overall-optimization-4.md)
