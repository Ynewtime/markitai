---
source: https://raw.githubusercontent.com/openai/openai-python/refs/heads/main/README.md
---
...
The REST API documentation can be found on [platform.openai.com](https://platform.openai.com/docs/api-reference). The full API of this library can be found in [api.md](./openai_python_api.md).
...
The full API of this library can be found in [api.md](./openai_python_api.md).
